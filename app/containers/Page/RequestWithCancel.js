...
export default class RequestWithCancel extends Component {
  render() {
    return (
      <div class="wrapper">
                                                                ...
                                                                <div class="row">
                                                                  <div class="col-md-6">
                                                                    ...
                                                                    <div class="btn-group mt-5 justify-content-end">
                                                                      <div>
                                                                        <a class="btn btn-outline-primary ml-3" href="javascript:;" data-toggle="modal" data-target="#cancelrequest">  إلغاء الطلب </a>
                                                                      </div>
                                                                    </div>
                                                                  </div>
