...
export default class ManageTravelAgencies extends Component {
  render() {
    return (
      <div class="wrapper">
          ...
          <div class="container ">
            <nav aria-label="breadcrumb">
              <ol class="bg-transparent breadcrumb mb-2 p-0 small text-muted">
                ...
                <li class="breadcrumb-item active" aria-current="page"> ادارة وكالات الاسفار </li>
              </ol>
            </nav>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="view_travel_agency.html" class="view-action" title="View item"><i class="fal fa-eye fa-fw fa-1x"></i>
