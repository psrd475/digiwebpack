              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="col-md-6 col-lg-4">
                      <div class="form-group ">
                        ...
                        <select class="form-control">
                          <option value="">شركة للسياحة والسفر</option>
                          <option value="">شركة نقل وتوصيل</option>
                          <option value="">شركة x</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                      <div class="form-group ">
                        <label class="d-block col-form-label"> حالة الطلب </label>
                        <select class="form-control">
                  ...
                  <div class="mt-2 text-right">
                    <a href="javascript:;" class="btn btn-block-mobile btn-primary">بحـــث</a>
                  </div>
                </div>
                <div class="page-inner">
                  <div class="mt-n4">
                    <ul class="nav nav-tabs border-bottom f-tabs mb-4  mx-n4 nav nav-tabs pb-1 sticky-top" id="myTab" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active" id="current-tab" data-toggle="tab" href="#current" role="tab" aria-controls="current"
                          aria-selected="true">الطلبات الحالية</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" id="prev-tab" data-toggle="tab" href="#prev" role="tab" aria-controls="prev"
                          aria-selected="false">الطلبات السابقة</a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane   show active" id="current" role="tabpanel" aria-labelledby="current-tab">
                      <!-- <h3 class="text-primary">نتائج البحــث</h3> -->
                    <div class="table-responsive">
                        <table class="table table-bordered table-light table-striped">
                          ...
                          <tbody>
                            <tr>
                              <td scope="row">21821477</td>
                              <td>مؤسسة المواسم الرائدة للسياحة </td>
                              <td>2020/09/08</td>
                              <td>تونس</td>
                              <td>شركة للسياحة والسفر</td>
                              <td><span class="badge badge-info">جديد</span></td>
                              <td class="text-center">
                                <a href="view_request.html" class="view-action" title="View item"><i class="fal fa-eye fa-fw fa-1x"></i>
                            ...
                            <tr>
                              ...
                              <td>مصر</td>
                              <td>شركة للسياحة والسفر</td>
                              <td><span class="badge badge-success">تم تحديثه</span></td>
                              <td class="text-center">
                                <a href="view_request.html" class="view-action" title="View item"><i class="fal fa-eye fa-fw fa-1x"></i>
                                  <span class="d-none">View item</span>
                                </a>
                            ...
                            <tr>
                              ...
                              <td>تونس</td>
                              <td>شركة للسياحة والسفر</td>
                              <td><span class="badge badge-warning"> منتظر التحديث</span></td>
                              <td class="text-center">
                                <a href="view_request.html" class="view-action" title="View item"><i class="fal fa-eye fa-fw fa-1x"></i>
                                  <span class="d-none">View item</span>
                                </a>
                            ...
                            <tr>
                              ...
                              <td>المغرب</td>
                              <td>شركة للسياحة والسفر</td>
                              <td><span class="badge badge-light">تم إلغاؤه    </span></td>
                              <td class="text-center">
                                <a href="view_request.html" class="view-action" title="View item"><i class="fal fa-eye fa-fw fa-1x"></i>
                                  <span class="d-none">View item</span>
                                </a>
