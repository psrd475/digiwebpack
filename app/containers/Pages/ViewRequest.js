            ...
            <div class="container ">
              <nav aria-label="breadcrumb">
                <ol class="bg-transparent breadcrumb mb-2 p-0 small text-muted">
                  ...
                  <li class="breadcrumb-item"><a href="request_list.html">طلبات تسجيل وكالات الاسفار</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> طلب رقم  28304770  </li>
                </ol>
              </nav>
              <div class="page-title">
                <h1 class="h1 text-primary"> طلب رقم  28304770   <span class="ml-3"><span class="badge badge-success ">مقبول  </span></span></h1>
              </div>
                                                                  ...
                                                                  <div class="row">
                                                                    <div class="col-md-6">
                                                                      ...
                                                                      <div class="btn-group mt-5 justify-content-end">
                                                                        <div>
                                                                          <a href="javascript:;" class="btn btn-outline-primary ml-3" data-toggle="modal" data-target="#updateRequest"> ارجاع الطلب للتحديث   </a>
                                                                          <a href="javascript:;" class="btn btn-outline-primary ml-3" data-toggle="modal" data-target="#rejectRequest"> رفض   </a>
                                                                          <a href="request_list.html" class="btn btn-primary ml-3"> قبول   </a>
                                                                        </div>
                                                                      </div>
                                                                    </div>
