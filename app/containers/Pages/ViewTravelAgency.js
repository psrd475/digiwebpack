...
export default class ViewTravelAgency extends Component {
  render() {
    return (
      <Fragment>
        <div class="wrapper">
            ...
            <div class="container ">
              <nav aria-label="breadcrumb">
                <ol class="bg-transparent breadcrumb mb-2 p-0 small text-muted">
                  ...
                  <li class="breadcrumb-item"><a href="Manage_Travel_Agencies.html">طلبات تسجيل وكالات الاسفار</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> وكالة مملكة تونس للأسفار و السياحة </li>
                </ol>
              </nav>
              <div class="page-title d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                <h1 class="h1 text-primary"> وكالة مملكة تونس للأسفار و السياحة  <span class="ml-3"><span class="badge badge-success ">نشط  </span></span></h1>

                <div class="dropdown action-droplist mb-3">
                  <a class="btn btn-outline-primary dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> العمليات </a>
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="#"><span> عرض البرنامج</span><i class="fal fa-suitcase fa-fw text-primary"></i> </a>
                    <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#freez"><span> تجميد الحساب</span><i class="fal fa-lock-alt fa-fw text-primary"></i> </a>
                    <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#ban"><span> حظر الحساب</span><i class="fal fa-ban fa-fw text-primary"></i> </a>
                  </div>
                </div>
              </div>
